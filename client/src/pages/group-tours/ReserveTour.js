...
const ReserveTour = ({ TourData }) => {
  ...
  const [totalPriceTour, setTotalPriceTour] = useState(0);
  ...
  useEffect(() => {
    const totalDays =
      ...
      1;
    const totalPrice = Tourprice * totalDays;

    setTotalPriceTour(totalPrice);
  }, [dateRange]);
    ...
    <Formik
      ...
      onSubmit={(values, { setSubmitting }) => {
        const data = {
          ...
          startDate: sDate,
          endDate: eDate,
          totalPrice: totalPriceTour,
          TourName: TourData.carModel,
        };
        console.log("data ", data);

        axios
          .post("http://localhost:8800/api/addTour-booking", data)
          .then((response) => {
            ...
            <div className="form-group row my-2">
              ...
              <div className="col-sm-10">
                <input
                  className="form-control"
                  type="text"
                  placeholder={`Rs. ${Tourprice} per day`}
                  readOnly={true}
                ></input>
              </div>
            </div>
